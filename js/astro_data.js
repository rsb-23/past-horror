SUNSIGNS = {
  ...
  Cancer:
    ' Beneficial for students. Right time to choose for your career. Money will be used for family expenses. Comfortable Journey.',
  Capricorn:
    ' Family meeting will be happy. You will find easy to work in your workplace. You will meet with your old friends. Outgoing may be planned.',

  Gemini:
    ' Be-aware in your profession and problems will be created in your new work. You will be ignored in your family matter. Benefits in work.',
  ...
  Libra:
    ' Can start a work in patnership. You will face a lot of work and you might require others help, which will reduce your work.',
  Pisces:
    ' Blocked money will be regained. Loss in profession due to lack of patience. Certificates from friends will be helpful. Decrease in unneccessary work load.',

  Sagittarius:
    ' Youth will get jobs according to will. Be soft in your talking. Profits in property matter. You will get opportunity for taking part in social occasions.',
  Scorpio:
    ' You will get willing sucess. Enviroment will be created as per your desire. You will meet with old friends. You will be free from exeternal stresses.',
  Taurus:
    ' Opponent will try to harm you. Others will try to take advantage of your identity. Break in the friendship.',
  Virgo:
    ' Health related tensions. Fight for small things. Profits from that place where you thought that it will a loss.',
};

BIRDS = {
  Albatross:
    'Usually your mind is in divert condition, but you can go to any\n limit to achieve something. You always get puzzled in useless things.',
  Custrail:
    'It is the magic of your mind that you can deviate your mind from one\n topic to another without losing your concentration. You have your fix sight at your\n aim of your life and no one can remove you from it. With the strength of your\n self-confidence you can touch any heights.',
  Dove: 'You are very quiet and polite. You like to live a romantic life and\n satisfies everyone. Although sometimes people suppress you by taking\n advantage of your quiet nature.',
  Eagle:
    'You have powerful vision for which world respects you. You never get\n busy in worthless activities and your sight is enough to quiet your opponents.\n You know better to come out of small problems (like fight with friends, etc).',

  Goldfinch:
    'You are alert living colourful person. Highly emotional. You like\n living in group as you feel requirement for safety. You require a medium to\n show your imaginary ability.',
  Hawk: 'A powerful personality who is full of bravery and willpower.\n You solve problems with skill. But you require your energy to concentrate \n full on your target.',
  Heron:
    'You are some what doubtful. You mainly like to live alone, but you want\n to live in a busy place where everyone knows you. You have extreme bravery\n to face problems of life. But You are enough insecure and therefore always\n hungry for compliment.',
  Kingfisher:
    'A colourful character who is always excited to do some\n or the other thing. your speed is very high. You have emotional attachment\n with water. You have sharp mind and with this strength you can dive where\n others afraid to.',

  Nightingale:
    'Your presence is felt before your seen. Everytime you have some\n or the other thing about yourself to tell. You have good relations with your partner.\n You have such a personality in your simple body which is ready to come out.',
  Raven:
    'Your always effective. Heap of energy. You are more intelligent than\n the people at your surroundings and known as in a image of problem solver.\n You likes challenge. ',
  Robin:
    "You are cool in appearance, but filled with fire inside. You've thoughts\n on every thing, which generally didn't match with others' thought. You r\n full of proudness and love home very much. But sometimes you become fightful.",
  Swan: 'Your character is highy complex. You look quiet and solved from\n outside, but from inside you struggle to match your speed with the modern\n fashion. You may be violent if someone raise you.',

  Woodpecker:
    "Your specialities are your stamina, hardwork and ability to face\n problems. If anyone feels your ideas worthless, then also you arrange to support\n them. You don't leave space for your neighbours in your noisy and free life style.",
};

TREES = {
  Apple:
    ' Quiet and shy at times, lots of charm, appeal, an attraction, pleasant \n attitude, mischievous smile, adventurous, sensitive, loyal in love, wants to  \n love and be loved, faithful and tender partner, very generous, many talents,\n loves children,needs affectionate people around.',
